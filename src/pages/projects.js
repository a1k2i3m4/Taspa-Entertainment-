...
const FeaturedProjects = ({type, title, summary, link, img, github}) => {
    return (
        <article
            ...
            <Link href={link} target={"_blank"}
                ...
                <FramerImage src={img} alt={title} className="w-full h-auto" whileHover={{scale:1.05}}
                             transition={{duration: 0.2}} priority sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 50vw"
                />
            </Link>
            <div className={"w-1/2 flex flex-col items-start justify-between pl-5 lg:w-full lg:pl-0 lg:pt-6"}>
                ...
                <div className={"mt-2 flex items-center "}>
                    <Link href={github} target={"_blank"} className={"w-10"}>
                        <YoutubeIcon src={github} alt=" Icon" className="w-10"/>
                    </Link>
                    <Link href={link} target={"_blank"}
            ...
            <div className={"w-full flex flex-col items-start justify-between mt-4"}>
                ...
                <div className={"w-full mt-2 flex items-center justify-between"}>
                    ...
                    <Link href={github} target={"_blank"} className={"w-8 md:w-6"}>
                        <YoutubeIcon src={github} alt=" Icon"/>
                    </Link>
                </div>
            </div>
        </article>
...
const Projects = () => {
    return (
        <>
            <Head>
                <title>Taspa | Projects Page</title>
                <meta name="description" content="Generated by Akim" />
            </Head>
            <Transition/>
            <main className={"w-full flex flex-col mb-16 items-center justify-center dark:text-light"}>
